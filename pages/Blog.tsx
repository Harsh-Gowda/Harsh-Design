...
import { Clock, ArrowRight, Tag, Search, Zap, Code, TrendingUp, Layers } from 'lucide-react';

// Fix: Use any cast for motion components
const motion = motionBase as any;

const categories = ["All", "Automation", "Fintech", "E-Commerce"];
...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Reducing TTFB to under 100ms for flash sale pages. A case study in aggressive caching, React virtualization, and converting click-intent into sales.",
    date: "Sep 10, 2023",
    readTime: "6 min read",
    category: "E-Commerce",
    tags: ["Performance", "UX", "Affiliate"],
