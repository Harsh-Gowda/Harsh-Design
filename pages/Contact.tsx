          ...
          <div className="space-y-10">
            <div className="space-y-4">
              ...
              <motion.h1
                ...
                className="text-3xl md:text-5xl font-heading font-extrabold leading-tight text-white"
              >
                Let's Build <br />
              ...
              >
                Stuck with a slow website? Broken checkout flow? Or just starting and need a foundation that won't collapse at scale? Let's fix it properly — clean code, fast delivery, zero technical debt.
              </motion.p>
            </div>
            ...
            >
              {[
                { icon: Github, href: "https://github.com/Harsh-Gowda", color: "#ffffff", label: "Github" },
                { icon: Linkedin, href: "#", color: "#0077b5", label: "LinkedIn" },
                { icon: Instagram, href: "https://www.instagram.com/harsh_____gowda?igsh=a2R5NGlxajU1OXhv", color: "#E1306C", label: "Instagram" },
                { icon: MessageCircle, href: "https://wa.me/+918088727376", color: "#25D366", label: "WhatsApp" }
              ].map((social, i) => (
                <motion.a
                  key={i}
                  href={social.href}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  >
                    <option value="Ai Automation" className="bg-[#0B1120]">AI Automation</option>
                    <option value="Freelance Project" className="bg-[#0B1120]">Freelance Project</option>
                    <option value="WordPress Development" className="bg-[#0B1120]">WordPress/Ecommerce Development</option>
