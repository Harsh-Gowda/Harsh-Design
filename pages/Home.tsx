...
import { 
  ...
  Terminal, Shield, Layers, Rocket, Lock,
  ...
  const projects = [
    {
      ...
      stat: "₹50K+ Monthly Rev",
      tech: ["React", "Node.js"],
      desc: "High-performance deal discovery engine with automated price tracking.",
      link: "/pickry",
    ...
    },
    {
      ...
      stat: "200+ Traders",
      tech: ["React", "Supabase"],
      desc: "Psychology-first trading journal.",
      link: "/trademind",
    ...
    },
    {
      ...
      stat: "50+ Daily Bookings",
      tech: ["WhatsApp API", "AI"],
      desc: "Conversational travel agent.",
      link: "/safarbot",
      image: "https://images.unsplash.com/photo-1526495124232-a04e1849168c?auto=format&fit=crop&q=80&w=800",
      className: "md:col-span-1"
    },
    {
      ...
      desc: "Complete overhaul of a high-traffic design agency portfolio.",
      link: "/projects", 
        ...
        <div className="z-10 flex flex-col items-center text-center max-w-6xl mx-auto space-y-8 md:space-y-12 relative w-full">
           ...
           <div className="space-y-6 md:space-y-8">
               <div className="h-6 flex justify-center items-center">
                 <Terminal size={14} className="text-[#06B6D4] mr-2" />
               ...
               <motion.h1 
                 ...
                 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-heading font-extrabold text-white leading-[0.95] tracking-tight px-2"
               >
                 Architecting Digital Ecosystems <br />
                 <span className="text-[#06B6D4]">For Scale & Speed.</span>
               </motion.h1>
             ...
             >
                ...
                <div className="relative z-20 h-full flex flex-col justify-end p-6 md:p-8">
                   ...
                   <div className="space-y-3 md:space-y-4">
                      <div className="flex items-center gap-2 text-[#06B6D4] text-xs font-bold font-mono">
                         <TrendingUp size={14} /> {project.stat}
                      </div>
